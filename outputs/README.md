...
This folder contains Monte Carlo robustness, stress, baseline, and optimizer maturity outputs.
...
- **Method:** Demo and stress scenarios compared across ORBITAL, random search,
  simple heuristics, and an `exhaustive_grid` solver-style baseline
- **Artifacts:** `validation/optimizer_maturity/optimizer_maturity.csv` and
  `validation/optimizer_maturity/optimizer_maturity.md`
- **Scope:** Reproducible research/demo evidence, not production-grade optimizer
  validation against established mission planning tools
