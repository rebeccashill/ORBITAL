...
| Geofence / no-fly-zone clearance | PASS | 282.7 m | Checks whether the route remains outside no-fly zones and preserves the configured stand-off buffer. | Geofence clearance protects people, assets, restricted areas, and customer boundaries when navigation or wind uncertainty appears. | Keep the geofence file and route review in the evidence bundle, then confirm site boundaries before flight. |
...
| Turn / bank feasibility | PASS | 0.244 rad/s | Checks whether planned turns stay within configured bank-angle and turn-rate capability. | Overly aggressive turns can break route tracking, increase energy use, and reduce safety margins near assets or geofences. | Keep the planned speed and turn assumptions, then verify they match the aircraft operating envelope. |
...
| final simulated battery | 838.3014675574134 | Wh | simulation.scalars.final_battery_Wh |
| energy used | 11.698532442586611 | Wh | simulation.scalars.energy_used_Wh |
...
| minimum simulated clearance | 357.7279657400859 | m | simulation.scalars.geofence_min_clearance_m |
...
| planned cruise speed | 13.909733380320986 | m/s | plan.metadata.cruise_speed_mps |
...
- Scenario path: examples/bvlos_fixtures/bvlos_missing_artifact_fixture.yaml
- Seed: 13
- Iterations: 8
- Restarts: 1
- Robustness cases configured: 0
- Robustness cases run: 0
- Command: python -m mission_framework.cli examples\bvlos_fixtures\bvlos_missing_artifact_fixture.yaml --generated-at 2026-09-15T05:24:50Z --outdir outputs\bvlos_fixtures
...
- Battery reserve margin: PASS, margin 138.3 Wh, risk points 10.2
...
- Observed evidence: final battery Wh: 838.3; required reserve Wh: 700.0
...
- Observed evidence: required clearance m: 75.0; min clearance m: 357.7; geofence violated: no
