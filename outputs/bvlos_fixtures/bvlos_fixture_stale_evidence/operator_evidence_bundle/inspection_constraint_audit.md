...
| Geofence / no-fly-zone clearance | PASS | 272.7 m | Checks whether the route remains outside no-fly zones and preserves the configured stand-off buffer. | Geofence clearance protects people, assets, restricted areas, and customer boundaries when navigation or wind uncertainty appears. | Keep the geofence file and route review in the evidence bundle, then confirm site boundaries before flight. |
...
| Turn / bank feasibility | PASS | 0.201 rad/s | Checks whether planned turns stay within configured bank-angle and turn-rate capability. | Overly aggressive turns can break route tracking, increase energy use, and reduce safety margins near assets or geofences. | Keep the planned speed and turn assumptions, then verify they match the aircraft operating envelope. |
...
| final simulated battery | 836.1727019315695 | Wh | simulation.scalars.final_battery_Wh |
| energy used | 13.827298068430537 | Wh | simulation.scalars.energy_used_Wh |
...
| minimum simulated clearance | 347.65625076948845 | m | simulation.scalars.geofence_min_clearance_m |
...
| planned cruise speed | 19.03973812524951 | m/s | plan.metadata.cruise_speed_mps |
...
- Scenario path: examples/bvlos_fixtures/bvlos_stale_evidence_fixture.yaml
- Seed: 12
- Iterations: 8
- Restarts: 1
- Robustness cases configured: 1
- Robustness cases run: 1
- Command: python -m mission_framework.cli examples\bvlos_fixtures\bvlos_stale_evidence_fixture.yaml --generated-at 2026-09-15T05:24:50Z --outdir outputs\bvlos_fixtures
...
- Battery reserve margin: PASS, margin 136.2 Wh, risk points 10.5
...
- Observed evidence: final battery Wh: 836.2; required reserve Wh: 700.0
...
- Observed evidence: required clearance m: 75.0; min clearance m: 347.7; geofence violated: no
