...
Mission: bvlos_stale_evidence_fixture
...
Scenario SHA-256: d1ab734cc550ef53d571715d02c0916a63953a97b8b6b0c74783556a8684f88a
Command used: python -m mission_framework.cli examples\bvlos_fixtures\bvlos_stale_evidence_fixture.yaml --generated-at 2026-09-15T05:24:50Z --outdir outputs\bvlos_fixtures
Manifest version: 1
UI schema version: 1
...
| Robustness | PASS: 1 case(s), hard pass rate 100.0 %, worst hard margin 0.201. Confidence from configured robustness cases is scenario-limited and should be reviewed against operator uncertainty assumptions. | Review uncertainty assumptions before release. |
...
- Uncertainty / robustness status: PASS: 1 case(s), hard pass rate 100.0 %, worst hard margin 0.201. Confidence from configured robustness cases is scenario-limited and should be reviewed against operator uncertainty assumptions.
