...
## Mission Verdict: MODIFY

Modeled constraints do not support release as configured.

**Next action:** Modify the route, assumptions, or constraints, then regenerate the evidence bundle before operator review.
...
| Step | Open / verify |
| --- | --- |
| Verdict | MODIFY - Modify the route, assumptions, or constraints, then regenerate the evidence bundle before operator review. |
| Top constraint | Battery reserve margin, FAIL, margin -41.0 Wh |
...
The verdict is MODIFY because the modeled mission status is not GO. Route, assumptions, or constraints should be changed before review.

| Verdict input | Current value | Derivation rule |
| --- | --- | --- |
| Modeled mission status | MODIFY | MODIFY if not GO. |
...
| Verdict | MODIFY |
| Modeled mission status | MODIFY |
| Mission risk | HIGH |
| Top limiting constraint | Battery reserve margin, FAIL, margin -41.0 Wh |
...
| Evidence warning status | REVIEW REQUIRED: 1 missing artifact(s), 15 stale artifact(s), 1 missing evidence item(s), 20 bundle warning(s) |
...
| --- | --- | --- |
| Verdict | MODIFY | Modify the route, assumptions, or constraints, then regenerate the evidence bundle before operator review. |
| Modeled mission status | MODIFY | Use as the first feasibility read from the constraint audit. |
| Mission risk | HIGH | Treat higher risk as a cue for additional operator review. |
| Top limiting constraint | Battery reserve margin, FAIL, margin -41.0 Wh | Review this constraint before changing or releasing the mission. |
...
| Evidence warnings | REVIEW REQUIRED: 1 missing artifact(s), 15 stale artifact(s), 1 missing evidence item(s), 20 bundle warning(s) | Check stale, missing, or mismatched evidence before archiving. |
...
Scan summary: 15 stale, 1 missing, 0 mismatched, 1 missing evidence item(s), 20 warning(s).
...
- Modify the route, assumptions, or constraints, then regenerate the evidence bundle before operator review.
